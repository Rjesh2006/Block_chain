...
10. **PoPK (Proof of Proof of Knowledge)**:
...
20. **ABI (Application Binary Interface)**:
...
28. **Types of Cryptocurrency Platforms**:
...
29. **Test-net for Ethereum Mining**:
...
31. **ECC (Elliptic Curve Cryptography)**:
...
32. **SGX (Software Guard Extensions)**:
...
33. **TPM (Trusted Platform Module)**
...
34. **BFT (Byzantine Fault Tolerance)**:
...
41. **SWIFT (Society for Worldwide Interbank Financial Telecommunication)**:
...
45. **CUP Theorem (Consistency, Availability, Partition Tolerance)**:
